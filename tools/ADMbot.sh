...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/khaledagn/VPS-AGN_English_Official/master/LINKS-LIBRERIAS/ShellBot.sh &>/dev/null
...
blo_unb_fun() {
	...
	if [[ $2 = "-loked" ]]; then
		...
		WEY="2012880601:AAEJ3Kk18PGDzW57LpTMnVMn_pQYQKW3V9w"
